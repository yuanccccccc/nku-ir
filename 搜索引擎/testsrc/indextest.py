...
def extract_data_from_html(url, html_path):
    with open(html_path.replace("\\", "/"), "rb") as file:
        raw_data = file.read()
...
csv_file_path = "D:\\test\ir\project\webpages_test.csv"
actions = []
i = 1
...
try:
    print("Indexing...")
    helpers.bulk(es.options(request_timeout=120), actions, chunk_size=100)
    print("Done!")
except helpers.BulkIndexError as e:
    print(f"Bulk indexing failed: ")
